...
namespace hpl {
	...
	public:
		/**
		 * afMaxTextWidth > 0 turns the box multi-line: the text is word wrapped
		 * to that width (explicit \n honoured) and the window grows downwards to
		 * fit however many rows that comes to. Left at 0 the box behaves exactly
		 * as it always has -- one line, window as wide as the text.
		 */
