...
namespace hpl {
	...
	bool cResources::TranslateExists(const tString& asCat, const tString& asName)
	{
		if(mpLanguageFile==NULL) return false;

		return mpLanguageFile->EntryExists(asCat, asName);
	}
