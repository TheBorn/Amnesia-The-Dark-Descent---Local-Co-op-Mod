...
public:	
	...
	//A level door has no lock or unlock sound of its own -- SetLocked is a bare
	//flag setter -- so this, the sound for trying a locked one, is the only door
	//sound there is to play.
	const tString& GetLockedSound(){ return msLockedSound;}
