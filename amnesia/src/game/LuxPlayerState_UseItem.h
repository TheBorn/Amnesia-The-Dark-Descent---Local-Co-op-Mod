...
protected:
	...
	// Coop: giving the held item to the other player. While the other player
	// is under the crosshair and in reach, the interact glow shows and
	// interacting hands the item over instead of using it on the world.
	bool CheckOtherPlayerInFocus();
	void GiveItemToOtherPlayer();

	cLuxInventory_Item *mpCurrentItem;
	cLinearOscillation mFlashOscill;

	bool mbOtherPlayerInFocus;
