...
public:	
	...
	// Coop: per-viewport toggle of the VISUALS only — mesh, billboards
	// (flame bloom) and particles. The lights are never touched, so the
	// lantern glow keeps shining in every player's view.
	void SetModelVisible(bool abVisible);
