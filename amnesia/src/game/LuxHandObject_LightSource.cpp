...
{
	// Get the player that owns this hand object (P1 or P2)
	cLuxPlayer *pOwner = mpHands->GetPlayer();
	...
	// Update vel
	{
		...
		/////////////////////////////
		// Player velocity
        iCharacterBody *pCharBody = pOwner->GetCharacterBody();
